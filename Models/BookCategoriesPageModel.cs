...
namespace Cucui_Elena_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel 
    {
        public List<AssignedCategoryData> AssignedCategoryDataList; 
        public void PopulateAssignedCategoryData(Cucui_Elena_Lab8Context context, Book book)
    {
    ...
    AssignedCategoryDataList = new List<AssignedCategoryData>();
        ...
        public void UpdateBookCategories(Cucui_Elena_Lab8Context context, 
        ...
        { 
            ...
            foreach (var cat in context.Category) 
            {
                ...
                else { if (bookCategories.Contains(cat.ID))
                    { 
